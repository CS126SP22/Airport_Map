...
namespace path_finding {
    ...
    public:
         ...
         */
        const vector<Vertex> & getAdjacent(Vertex source) const;
         ...
         */
        const Vertex & getStartingVertex() const;
         ...
         */
        const Edge & getEdge(Vertex source, Vertex destination) const;
     ...
     */
         ...
         */
        const string & getEdgeLabel(Vertex source, Vertex destination) const;
